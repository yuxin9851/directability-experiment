...
DEFAULT_WORLDSETTINGS: dict={
    ...
    'tick_duration': 0.2, # Set to 0 for fastest possible runs.
    'random_seed': 1,
    'verbose': False,
    'matrx_paused':True,
    ...
    'average_blocks_per_room': 1.4,
    'block_shapes': [0, 1], # possible shapes of the blocks
    ...
    'human_sense_agent_range': 50,
    'human_sense_block_range': 5, # the range with which human detect blocks
    'tiger_sense_range': 1, # the range with which tiger detect human
    'fire_sense_range': 1, # the range with
...
class BW4TWorld:
    ...
    def _addAgents(self):
        ...
        tiger_sense_capability = SenseCapability({
            AgentBody: self._worldsettings['tiger_sense_range'],
            CollectableBlock: self._worldsettings['tiger_sense_range'],
            None: self._worldsettings['other_sense_range']})

        fire_sense_capability = SenseCapability({
            AgentBody: self._worldsettings['fire_sense_range'],
            CollectableBlock: self._worldsettings['fire_sense_range'],
            None: self._worldsettings['other_sense_range']})

        human_sense_capability = SenseCapability({
            AgentBody: self._worldsettings['human_sense_agent_range'],
            CollectableBlock: self._worldsettings['human_sense_block_range'],
            None: self._worldsettings['other_sense_range']})
    ...
    def _addRooms(self):
        ...
        for room_nr in range(self._worldsettings['nr_rooms']):
            ...
            room_locations[room_name] = self._builder.get_room_locations(room_top_left, self._worldsettings['room_size'][0], self._worldsettings['room_size'][1])
